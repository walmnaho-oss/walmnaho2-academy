  ...
  return (
    <main className="relative min-h-screen bg-[#F8FAFC] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] bg-indigo-500/[0.04] rounded-full blur-[160px]" />
        <div className="absolute bottom-[-20%] left-[-10%] w-[50%] h-[50%] bg-teal-500/[0.03] rounded-full blur-[160px]" />
        <div
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 pt-32 md:pt-40 pb-20">
        ...
        <div className="max-w-4xl mx-auto space-y-5">
          {t.terms.sections.map(
            (section: { title: string; content: string }, index: number) => (
              ...
              >
                <div className="relative rounded-2xl p-8 md:p-10 bg-[#0F172A] border border-slate-800/60 hover:border-indigo-500/30 transition-all duration-500 shadow-lg hover:shadow-xl hover:shadow-indigo-500/5">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="hidden sm:flex w-8 h-8 rounded-lg bg-indigo-500/10 border border-indigo-500/20 items-center justify-center flex-shrink-0 mt-0.5">
        ...
        >
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-500 text-sm mt-2 transition-colors"
          >
